...
<body>
    <div class="main-container">
        ...
        <h1 class="pt-2 header"> Booking Successful ! </h1>
        <p class="mt-3 mb-4"> You will receive a phone call as soon as possible to confirm delivery location and discuss payment options </p>
